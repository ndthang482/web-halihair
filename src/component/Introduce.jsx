...
class Introduce extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      testimonials: [
        {
          text: "I am satisfied with your product, I continue to support you",
          image: "//theme.hstatic.net/200000490033/1000843621/14/nhanxet-1.jpg?v=51",
          name: "jeny"
        },
        {
          text: "The hair color is very beautiful, i love it",
          image: "//theme.hstatic.net/200000490033/1000843621/14/nhanxet-2.jpg?v=51",
          name: "jony"
        },
        {
          text: "work hard, I'm very satisfied",
          image: "//theme.hstatic.net/200000490033/1000843621/14/nhanxet-3.jpg?v=51",
          name: "halll"
        },
        {
          text: "I continue to support you",
          image: "//theme.hstatic.net/200000490033/1000843621/14/nhanxet-4.jpg?v=51",
          name: "wemy"
        }
      ]
    };
  ...
  toggleSidebarMenu() {
    ...
    render() {
      const { testimonials, selectedIndex } = this.state;
...
<div className="wrapper ">
  ...
  <div id="main-content">
    ...
    <div className="whoweare pd50">
      <div className="container-fluid">
        <div className="row-text">
          <div className="col-xs-12">
            <div className="who-title border-bottom">
              <h2 className="">Who are we</h2>
              <div className="who-shortdes">
                <p>Wig Manufacture</p>
              </div>
            </div>
          </div>
          <div className="col-xs-12">
            <div className="who-des">
              <div className="mt20">
                ...
                bald-cover wig, dyed wig, fashional wig… for both men and
                women. With the motto of putting quality first, all kinds of
                wig provided by Hali Hair are made from 100% real hair, help
                the customer to have a nature beatiful, soft hair and safe to
                use.
              </div>
    ...
    <div className="product-list album-block pd50">
      <div className="container-fluid">
        <a className='our-products' href="/products">Our products</a>
        <div className="row">
          <div id="owl-product" className="owl-carousel owl-theme" />
        </div>
      </div>
    </div>
    <div className="nhanxet-bg">
        <div className="container-fluid">
          <div className="row">
            <div className="col-xs-12 col-sm-8 col-md-6 pull-right">
              
              <div>
                <div id="owl-nhanxet" className="owl-carousel owl-theme">
                  <div className="testimonial active">
                    ...
                    <div className="whopic">
                      <img
                        ...
                        className="centered"
                        alt={`Ý kiến khách hàng ${selectedIndex + 1}`}
                      />
                      <strong>{testimonials[selectedIndex].name}</strong>
                    </div>
                  </div>
                </div>
              </div>
