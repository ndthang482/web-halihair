         ...
         products:  [
            {
              id: "1",
              name: "weft hair",
              image:"https://product.hstatic.net/200000490033/product/z4159745120524_dc7bd91e922685a6b9bd56bdcb1e49db_9b18d82c794d4565a1e20ca27c774e28_master.jpg",
              brand: "halihair",
      ...
      <div className="navbar active" id="sidebar-menu" style={{display: this.state.isSidebarMenuVisible || window.innerWidth > 1159 ? "block" : "none"}}>
            ...
            <div id="header-mobile-menu">
                  <div className="hidden" id="mmenu">
                    <ul>
                      ...
                      <a target="_blank" rel="nofollow" className="fa-facebook" href="https://www.facebook.com/profile.php?id=100086621584294" title="Facebook" />
                      <a target="_blank" rel="nofollow" className="fa-google" href="#" title="Google plus" />
        ...
        <div id="main-content">
          ...
          <div id="products" className="products clearfix" >
            <div className="container-fluid">
              <div className="">
                <div style={{display: this.state.selectedProduct ? "none" : "block"}}>
                ...
                <div className="col-xs-12">
                  <div id="wrapper-detail" style={{display: this.state.selectedProduct ? "none" : "block"}}>
                    <div className="row">
                          ...
                          <div className="thumb-mt20">
                            <div id="sliderproduct-mobile" className="img-product-detail">
                              <div className="item product-thumb">
                                <img alt="weft hair"
                                src="https://product.hstatic.net/200000490033/product/z4159745120524_dc7bd91e922685a6b9bd56bdcb1e49db_9b18d82c794d4565a1e20ca27c774e28_master.jpg" />
                              </div>
                              <div className="item product-thumb">
                                <img alt="weft hair"
                                src="https://product.hstatic.net/200000490033/product/z4159745120524_dc7bd91e922685a6b9bd56bdcb1e49db_9b18d82c794d4565a1e20ca27c774e28_master.jpg"/>
            ...
            <div className="container-fluid">
              <div className="row">
                ...
                <div className="col-xs-12 col-sm-6 col-md-6 footer-block">
                  ...
                  <h4 className="mt20">Đăng ký nhận khuyến mãi</h4>
                  <div className="newsletter">
                    <form acceptCharset="UTF-8" action="/account/contact" className="contact-form" method="post">
                      ...
                      <input name="contact[email]" type="email" id="contact_email" placeholder="Đăng ký email" required />
                      <button className="button button-sp">Đăng ký</button>
                      <input id="1c7c4a45a75646ce92707a15c69ee067" name="g-recaptcha-response" type="hidden" />
                    </form>
                  </div>
                </div>
              </div>
